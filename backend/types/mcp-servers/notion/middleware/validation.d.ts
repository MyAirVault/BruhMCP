...
declare namespace _default {
    export { isValidInstanceId };
    export { createInstanceIdValidationError };
    export { validateInstanceExists };
    export { validateServiceActive };
    export { validateInstanceStatus };
    export { validateInstanceNotExpired };
    export { validateOAuthCredentials };
