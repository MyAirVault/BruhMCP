...
declare namespace _default {
    export { checkCachedCredentials };
    export { hasCachedBearerToken };
    export { setupRequestWithCachedToken };
    export { getTokenInfo };
    export { isAccessTokenValid };
    export { cacheAndSetupToken };
    export { cacheNewTokens };
    export { setupRequestWithNewTokens };
    export { setupLightweightRequest };
}
