 ...
 */
export function createAuthMiddleware(options?: AuthMiddlewareOptions | undefined): (req: import('express').Request, res: import('express').Response, next: import('express').NextFunction) => Promise<void>;
/**
