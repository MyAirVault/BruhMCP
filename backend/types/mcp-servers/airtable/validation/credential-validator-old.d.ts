 ...
 */
declare function createAirtableValidator(credentials: any): AirtableAPIKeyValidator;
/**
 * Airtable API Key Validator that implements BaseValidator interface
 */
declare class AirtableAPIKeyValidator {
     ...
     * @returns {Promise<Object>} Validation result
     */
    validateFormat(credentials: any): Promise<Object>;
    /**
     * Test credentials against actual API
     * @param {any} credentials - Credentials to test
     * @returns {Promise<Object>} Validation result
     */
    testCredentials(credentials: any): Promise<Object>;
    /**
     * Get service information
     * @param {any} _credentials - Validated credentials
     * @returns {Object} Service information
     */
    getServiceInfo(_credentials: any): Object;
}
//# sourceMappingURL=credential-validator-old.d.ts.map