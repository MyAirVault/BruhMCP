/**
 * Notion MCP Service Entry Point
 * API Key Implementation following Multi-Tenant Architecture
 */

/// <reference path="../../types/notion.d.ts" />
...
// Service configuration (from mcp-ports/notion/config.json)
const SERVICE_CONFIG = {
  name: 'notion',
  displayName: 'Notion',
  port: 49391,
  authType: 'api_key',
  description: 'Notion centralizes notes, docs, wikis, and tasks in a unified workspace, letting teams build custom workflows',
  version: '1.0.0',
  iconPath: '/mcp-logos/notion.svg'
};
...
// OAuth well-known endpoint (return 404 as Notion uses API keys, not OAuth)
