/**
 * OAuth Credential Authentication Middleware for Google Sheets MCP Service
  ...
  return async (req, res, next) => {
    ...
    try {
      ...
      if (!instance.service_active) {
        return ErrorResponses.serviceUnavailable(res, 'Google Sheets service is currently disabled', {
          instanceId,
          service: 'sheets'
        });
      }
