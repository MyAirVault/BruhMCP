...
export async function exchangeOAuthForBearer(credentials) {
    ...
    throw new Error('Centralized OAuth token exchange is deprecated. Gmail service now handles OAuth directly through Google\'s OAuth endpoints. Use the direct OAuth flow instead.');
}
/**
 * Refresh token data
