/**
 * Gmail MCP Service Entry Point
 * OAuth 2.0 Implementation following Multi-Tenant Architecture
 */

/// <reference path="../../types/gmail.d.ts" />
...
const SERVICE_CONFIG = {
  ...
  port: 49296,
  authType: 'oauth',
  description: 'Google\'s email service, featuring spam protection, search functions, and seamless integration with other G Suite apps',
  version: '1.0.0',
  iconPath: '/mcp-logos/gmail.svg',
  scopes: [
