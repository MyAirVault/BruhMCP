/**
 * GitHub MCP Service Entry Point
...
// Service configuration (from mcp-ports/github/config.json)
const SERVICE_CONFIG = {
  name: 'github',
  displayName: 'GitHub',
  port: 49294,
  authType: 'oauth',
  description: 'GitHub is a code hosting platform for version control and collaboration, offering Git-based repository management',
  version: '1.0.0',
  iconPath: '/mcp-logos/github.svg',
