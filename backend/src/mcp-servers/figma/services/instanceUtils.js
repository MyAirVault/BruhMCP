 ...
 */
async function getFigmaInstanceCredentials(instanceId) {
	const query = `
		SELECT 
			ms.instance_id,
			ms.user_id,
 ...
 */
async function updateFigmaUsageTracking(instanceId, userId) {
	const query = `
...
module.exports = {
	...
	getFigmaInstanceCredentials,
	updateFigmaUsageTracking
};